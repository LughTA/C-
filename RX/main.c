  ...
  while (1)
  {
		switch(state_machine)
		{
			...
			case calculator:
				...
				if(readValue_Y < 1900)
				{			
					Offset_Value = ((readValue_Y - 1900) * 1000)/(0 - 1900);
					
					EN1_Value -= Offset_Value;
					EN2_Value += Offset_Value;
					
					//range from 0 to 1000
					if (EN1_Value < 0) {
						EN1_Value = abs(EN1_Value);
						state_car = turn_right;
					}
					if (EN2_Value > 1000) {
						EN2_Value = 1000;
					}
				...
				if(readValue_Y > 2100)
				{
					Offset_Value = ((readValue_Y - 2100) * 1000)/(4095 - 2100);
